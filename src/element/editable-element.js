...
(function ($) {
    ...
    Editable.prototype = {
        ...
        init: function () {
            ...
            $.when(doAutotext ? this.input.value2html(this.getValue(), this.$element) : true).then($.proxy(function() {
        ...
        */          
        save: function(e, params) {
            ...
            if(typeof this.options.url !== 'function' && params.response === undefined && this.input.value2str(this.getValue()) !== this.input.value2str(params.newValue)) {
        ...
        **/         
        setValue: function(value, convertStr) {
            ...
            $.when(this.input.value2html(newValue, this.$element))
            .then($.proxy(function() {
                this.handleEmpty();
                this.$element.triggerHandler('render', this);                        
            }, this));
